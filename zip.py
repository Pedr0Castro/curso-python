...
# obs: o zip utiliza como parametro o menor tamanho em iteravel, isso significa que se estiver trabalhando com iteraveis
# de tamanho diferentes, irá parar quando os elementos do menor iterável acabar
lista3 = [7, 8, 9, 10, 11]
