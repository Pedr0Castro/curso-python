...
costumamos a criar métodos públicos para manipulação desses atributos. Esses métodos são
conhecidos por getters e setters, ode os getters retornam o valor do atributo e os setters
...
conta1 = Conta('Pedro', 3000, 5000)
conta2 = Conta('André', 2000, 4000)
