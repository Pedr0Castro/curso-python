...
podemos passar a execução da função para outras funções ou mesmo para outras funções.
...
# Exemplo 3 - Podemos em uma função, retornar qualquer tipo de dado, até mesmo multiplos valores;
...
# Erros comuns na utilização do retorno, que na verdade é uma cofificação necessária.
